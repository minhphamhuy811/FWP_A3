...
export default function Hero() {
	return(
		<div className="flex bg-primary justify-center items-center border border-transparent py-4 px-2 md:px-8">
			...
			<div className="flex flex-col justify-center items-center text-center border-l border-r px-4 border-white">
			...
			<div className="items-stretch md:items-center">
				<Link to={'/admin-login'} className="flex gap-x-2 font-bold button2 p-4 rounded-r-xl text-white justify-evenly items-center hover:text-primary hover:bg-white hover:border-white focus:text-red-700 focus:bg-gray-50">
