	...
	return(
		<div className="bg-primary">
			...
			<div className="items-stretch md:items-center">
				<Link to={'/admin-login'} className="flex gap-x-2 font-bold border border-transparent py-4 px-4 rounded-r-xl text-white justify-evenly items-center hover:text-primary hover:bg-white hover:border-white focus:text-red-700 focus:bg-gray-50">
