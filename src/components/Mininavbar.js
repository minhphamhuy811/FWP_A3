		...
		<nav className="bg-secondary">
			<div className="flex justify-center items-center">
				...
				<div className="grid grid-cols-3 items-stretch md:items-center">
					<Link to={'/'} className="flex button1 border-black border-l text-white p-2 justify-evenly items-center hover:text-red-700 hover:bg-white focus:text-red-700 focus:bg-gray-50">
					...
					<Link to={'/covid-information'} className="flex button2 border-black border-r text-white p-2 justify-evenly items-center hover:text-red-700 hover:bg-white focus:text-red-700 focus:bg-gray-50">
						<svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-1" viewBox="0 0 20 20" fill="currentColor">
							<path
